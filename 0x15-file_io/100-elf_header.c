...
void print_elf_class(unsigned char *el_ident);
void print_elf_data(unsigned char *el_ident);
void print_elf_version(unsigned char *el_ident);
void print_elf_abi(unsigned char *el_ident);
void print_os_abi(unsigned char *el_ident);
void print_elf_type(unsigned int e_type, unsigned char *el_ident);
void print_elf_entry(unsigned long int e_entry, unsigned char *el_ident);
